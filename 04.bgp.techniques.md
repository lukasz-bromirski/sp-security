...
* [S/RTBH and D/RTBH on Cisco XR with IPv4 and IPv6](https://community.cisco.com/t5/service-providers-documents/using-destination-and-source-based-bgp-rtbh-on-ios-xr-platforms/ta-p/3130673) 
* [BGP blackholing, sinkholing and FlowSec usage](https://lukasz.bromirski.net/docs/prezos/certee2017/BGP_Security_101.pdf)
* [BGP blackholing in MPLS VPN](https://community.cisco.com/t5/service-providers-documents/using-bgp-rtbh-in-vpnv4/ta-p/3118265)
